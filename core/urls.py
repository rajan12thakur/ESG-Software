...
urlpatterns = [
    ...
    path("departments/<uuid:object_id>/delete/", views.DepartmentDeleteView.as_view(), name="company-department-delete"),
    ...
    path("organization-units/<uuid:object_id>/delete/", views.OrganizationUnitDeleteView.as_view(), name="company-unit-delete"),
    ...
    path("organization-units/<uuid:unit_id>/facilities/<uuid:object_id>/delete/", views.UnitFacilityDeleteView.as_view(), name="company-unit-facility-delete"),
]
